...
namespace FM4CC.FaultModels.ControllerComparison
{
    internal class DataGridHeatPoint : INotifyPropertyChanged
    {
        ...
        private ControllerComparisonHeatPoint _containedHeatPoint;
        private bool _analyze;
        private double _desiredMax;
        private double _desiredMin;

        public bool PhysicalRangeExceeded1 
        {
            get
            {
                return _containedHeatPoint.PhysicalRangeExceeded2;
            }
        }

        public bool PhysicalRangeExceeded2
        {
            get
            {
                return _containedHeatPoint.PhysicalRangeExceeded2;
        ...
        public DataGridHeatPoint(ControllerComparisonHeatPoint hp, double baseUnit, double desiredMin, double desiredMax, string requirement)
        {
