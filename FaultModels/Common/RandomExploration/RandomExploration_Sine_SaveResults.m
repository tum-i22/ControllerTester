function [ ExplorationResults ] = RandomExploration_Sine_SaveResults(DesiredValues, ObjectiveFunctionValues, LimitDesiredValues, LimitObjectiveFunctionValues, TotalRegions, PointsPerRegion, TempPath)
    ...
    PointsFilePath = strcat(ResultsFolderPath, '\RandomExplorationPoints_Sine.csv');
    ...
    RegionsFilePath = strcat(ResultsFolderPath, '\RandomExplorationRegions_Sine.csv');
