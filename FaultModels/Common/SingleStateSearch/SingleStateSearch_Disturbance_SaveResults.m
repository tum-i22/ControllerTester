function SingleStateSearch_Disturbance_SaveResults(worstPoint, worstObjectiveFunctionValue, TempPath)
    ...
    ResultsFolderPath = strcat(TempPath, '\SingleStateSearchComparison');
